...
<Tabs>
  ...
  <Tab title="User">
    <Warning>
      These are **Discord** user fields. For Last.fm account data in `,lastfm mode`, use `{lastfm.name}`, `{lastfm.avatar}`, `{lastfm.plays}`, ; see the [Last.fm](/integrations/lastfm#custom-now-playing-embed-personal-premium) page.
    </Warning>
