...
This alias would run the `timeout` command with the first argument being `@melvin` from the user's input and the second argument being `10m` as predefined.
