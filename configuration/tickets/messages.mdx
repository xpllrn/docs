...
<Callout icon="terminal" color="#ff5d8f" iconType="regular">You can learn how to create your own embeds on the [Embeds](/resources/scripting/embeds) documentation page.</Callout>
<Callout icon="images" color="#ff5d8f" iconType="regular">Don't want to make your own? Check out our community-created [Showcase](https://discord.com/channels/721627270527188995/1306162710815313921) channel.</Callout>
